...
<main class="about-content about">
	<div class="about-section">
		...
		<article class="about-concept">
			...
			<h2><span></span>batterfly</h2>
			<P>Bow-tie だったりRibbonだったりテキスタイルを考え形成させます。</P>
			<P>その方に合った色味で作ることもありデザインは唯一無二。日常使いの蝶ネクタイを推奨。</P>
			<p>カラフルなものも多く、作者はTHE SAPEURとかイメージがありコンセプト共に好きです。</p>
			<h2><span></span>WA</h2>
			<P>和。</P>
			<P>作品によっては、パーツの一部に着物のハギレや和柄の古布を使っています。</P>
			<p>日本以外の国へ行った時に改めて気が付いた日本の美しさ。</p>
			<p>和 x 羊毛フェルトの可能性を模索しつつ、またハギレを活用するにあたりエコに対する表現を</P>
			<p>忘れずに作品展開をしています。無理なく、その輪が広がるように。</P>
		</article>
